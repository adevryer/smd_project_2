import LuckyThirteenGame.LuckyThirdteen;
import LuckyThirteenGame.PropertiesLoader;
...
public class TestScoring {
    class RoundData {
        ...
        public String toString() {
            return "Round " + roundNumber + ". Players.Player Selections: "  + playerSelections + ". Scores: " +
